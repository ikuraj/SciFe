...
class SortedTreeTest extends FunSuite with Matchers
  ...
  // TODO move to separate tests
    test("product") {
      val e1 = new e.WrapArray(Array(1, 2, 3)) with Touchable[Int]
      val e2 = new e.WrapArray(Array(1, 2, 3)) with Touchable[Int]
    ...
    test("product, right touched") {
      val e1 = new e.WrapArray(Array(1, 2, 3, 4)) with Touchable[Int]
      val e2 = new e.WrapArray(Array(1, 2, 3, 4)) with Touchable[Int]
