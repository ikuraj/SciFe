...
//  }
//  
//  test("visited red-black tree testcase") {
...
//    val streamables = new StreamablesImpl(streamFactory)
//    
//    streamables.initialize(filteredTrees)
//    
//    import Attribution._
//    
//    streamables.visited(filteredTrees) should have size (1)
//    streamables.visited(filteredTrees) should contain (filteredTrees: Element)
//    streamables.visited(chooserNode) should have size (2)
//    streamables.visited(chooserNode) should contain (chooserNode: Element)
//    streamables.visited(chooserNode) should contain (filteredTrees: Element)
//    streamables.visited(leafNode) should have size (3)
//    streamables.visited(leafNode) should contain (chooserNode: Element)
//    streamables.visited(leafNode) should contain (filteredTrees: Element)
//    streamables.visited(leafNode) should contain (leafNode: Element)
//    
//    // follow added links
//    streamables.visited(treeParamNode) should have size (4)
//    streamables.visited(treeParamNode) should contain (chooserNode: Element)
//    streamables.visited(treeParamNode) should contain (filteredTrees: Element)
//    streamables.visited(treeParamNode) should contain (consNode: Element)
//    streamables.visited(treeParamNode) should contain (treeParamNode: Element)
//  }
  
  test("allRecursiveLinksDownTheTree red-black tree testcase") {
    import RedBlackTrees._ 
...
//  test("memoization at right places, sorted lists testcase") {
//    
//    val intNode = Injecter(classOf[Int])
...
//    val streamables = new StreamablesImpl(streamFactory)
//    
//    val intStream = (1 to 5 toStream) zip Stream.continually(1)
//    
//    val resultStream = streamables.getStreamableList(
//      aggregatedIntNode,
//      Map.empty,
//      Map.empty,
...
//          assert(us.isInstanceOf[ord.Memoized[_]])
//        case _ => fail
//      }
//    }
//    
//  }
//  
  test("memoization at right places, red black trees testcase") {
    import RedBlackTrees._ 
    ...
    withClue(FormatStreamUtils(streamable)) {
      streamable match {
        case us: ord.FilterStream[_] =>
          assert(us.isInstanceOf[ord.Memoized[_]])
        case _ => fail
      }
    }
