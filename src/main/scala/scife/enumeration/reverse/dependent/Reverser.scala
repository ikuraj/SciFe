...
//    (implicit ct: ClassTag[F[_]]): ReverseDepend[I, O] = {
...
//        new d.WrapFunction[I, O, Reverse[O]](fun) with ReverseDepend[I, O] with
...
//    new d.WrapFunction[I, O, Reverse[O]](fun) with ReverseDepend[I, O] with d.DependFinite[I, O]
//  }

//  def apply[I, O, E <: Reverse[O]](fun: (d.Depend[I, O], I) => E): ReverseDepend[I, O] = {
//    new d.WrapFunction(fun) with ReverseDepend[I, O]
//  }
//
...
//        new d.WrapFunction[I, O, Infinite[O]](fun) with ReverseDepend[I, O] with d.DependInfinite[I, O]
//      case _ =>
//        new d.WrapFunction[I, O, F[O]](producerFunction) with ReverseDepend[I, O]
//    }
//  }
//
//  def memoized[I, O, F[O] <: Enum[O]](producerFunction: (d.Depend[I, O], I) => F[O])
//    (implicit ct: ClassTag[F[_]], ms: m.MemoizationScope = null): ReverseDepend[I, O] = {
//    val reverseTag = implicitly[ClassTag[Reverse[_]]]
//    val enum =
//      implicitly[ClassTag[F[_]]] match {
//        case `reverseTag` =>
