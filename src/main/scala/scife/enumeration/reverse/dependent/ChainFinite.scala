...
class ChainFinite[I, O]
  (override val left: ReverseFinite[I], override val right: ReverseDependFinite[I, O])
  extends dp.lzy.ChainFinite[I, O](left, right) with ReverseFinite[(I, O)] with HasLogger {
